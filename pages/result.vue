<template>
  <div class="result">
    ...
    <div class="svg-wrap">
      ...
      >
        <path d="M0 80.6H80V0.599999H0V80.6Z" fill="url(#pattern0)" />
        <defs>
          <pattern
            id="pattern0"
